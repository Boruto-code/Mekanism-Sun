...
public class AdvanceChemicalTankChemicalTank extends BasicChemicalTank {
    public static AdvanceChemicalTankChemicalTank create(AdvanceChemicalTankTier tier, @Nullable IContentsListener listener) {
        Objects.requireNonNull(tier, "Chemical tank tier cannot be null");
        return new AdvanceChemicalTankChemicalTank(tier, listener);
    }

    private final boolean isCreative;
    private final LongSupplier rate;

    private AdvanceChemicalTankChemicalTank(AdvanceChemicalTankTier tier, @Nullable IContentsListener listener) {
