...
import com.hamburger0abcde.mekanismsun.common.attachments.containers.MSComponentBackedBinInventorySlot;
import com.hamburger0abcde.mekanismsun.common.attachments.containers.MSComponentBackedChemicalTankTank;
import com.hamburger0abcde.mekanismsun.common.attachments.containers.MSComponentBackedFluidTankFluidTank;
...
public class MSBlocks {
    ...
    private static BlockRegistryObject<BlockLargeTransmitter<TileEntityAdvanceLogisticalTransporter>,
            MSItemBlockLogisticalTransporter> registerLogisticalTransporter(String nameTier,
                                                                            BlockTypeTile<TileEntityAdvanceLogisticalTransporter> type) {
        return registerTieredBlock(nameTier + "_logistical_transporter", () -> new BlockLargeTransmitter<>(type),
