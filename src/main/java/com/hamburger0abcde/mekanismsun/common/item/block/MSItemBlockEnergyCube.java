...
import com.hamburger0abcde.mekanismsun.common.attachments.containers.MSComponentBackedEnergyCubeContainer;
...
public class MSItemBlockEnergyCube extends MSItemBlockTooltip<BlockTileModel<TileEntityAdvanceEnergyCube,
        Machine<TileEntityAdvanceEnergyCube>>> implements CreativeTabDeferredRegister.ICustomCreativeTabContents {
    ...
    public MSItemBlockEnergyCube(BlockTileModel<TileEntityAdvanceEnergyCube,
            Machine<TileEntityAdvanceEnergyCube>> block, Item.Properties properties) {
    ...
    @Override
    public AdvanceEnergyCubeTier getAdvancedTier() {
        return MSAttribute.getAdvancedTier(getBlock(), AdvanceEnergyCubeTier.class);
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, Item.@NotNull TooltipContext context,
        ...
        tooltip.add(MekanismLang.CAPACITY.translateColored(EnumColor.INDIGO, EnumColor.GRAY,
                EnergyDisplay.of(getAdvancedTier().getAdvanceMaxEnergy())));
        super.appendHoverText(stack, context, tooltip, flag);
    }

    @Override
    protected void addTypeDetails(@NotNull ItemStack stack, @Nullable Item.TooltipContext context,
                                  @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
    ...
    protected EnergyContainersBuilder addDefaultEnergyContainers(EnergyContainersBuilder builder) {
        return builder.addContainer(MSComponentBackedEnergyCubeContainer::create);
    }
}
