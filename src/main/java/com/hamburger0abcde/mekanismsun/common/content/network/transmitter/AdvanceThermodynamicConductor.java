...
import com.hamburger0abcde.mekanismsun.common.capabilities.AdvanceVariableHeatCapacitor;
import com.hamburger0abcde.mekanismsun.common.tiers.transmitter.AdvanceConductorTier;
...
public class AdvanceThermodynamicConductor extends ThermodynamicConductor implements ITileHeatHandler,
        IAdvanceUpgradeableTransmitter<ThermodynamicConductorUpgradeData> {
    ...
    public final AdvanceVariableHeatCapacitor buffer;

    public AdvanceThermodynamicConductor(Holder<Block> blockProvider, TileEntityAdvanceTransmitter tile) {
        super(blockProvider, tile);
        this.tier = Attribute.getTier(blockProvider, ConductorTier.class);
        buffer = AdvanceVariableHeatCapacitor.create(AdvanceConductorTier.getHeatCapacity(tier), AdvanceConductorTier.getConduction(tier),
                AdvanceConductorTier.getConductionInsulation(tier), ambientTemperature, this);
