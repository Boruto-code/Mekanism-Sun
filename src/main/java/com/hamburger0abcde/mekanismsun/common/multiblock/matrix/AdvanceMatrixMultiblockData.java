...
public class AdvanceMatrixMultiblockData extends MultiblockData {
    public static final String STATS_TAB = "stats";

    private final List<EnergyOutputTarget> energyOutputTargets = new ArrayList<>();
    @NotNull
    private final AdvanceMatrixEnergyContainer energyContainer;
    ...
    public AdvanceMatrixMultiblockData(TileEntityAdvanceInductionCasing tile) {
        super(tile);
        energyContainers.add(energyContainer = new AdvanceMatrixEnergyContainer(this));
    ...
    public void addCell(TileEntityAdvanceInductionCell cell) {
        energyContainer.addCell(cell.getBlockPos(), cell);
    }

    public void addProvider(TileEntityAdvanceInductionProvider provider) {
        energyContainer.addProvider(provider.getBlockPos(), provider);
    }

    @NotNull
    public AdvanceMatrixEnergyContainer getEnergyContainer() {
    ...
    protected void updateEjectors(Level world) {
        ...
        for (IValveHandler.ValveData valve : valves) {
            TileEntityAdvanceInductionPort tile = WorldUtils.getTileEntity(TileEntityAdvanceInductionPort.class, world, valve.location);
            if (tile != null) {
