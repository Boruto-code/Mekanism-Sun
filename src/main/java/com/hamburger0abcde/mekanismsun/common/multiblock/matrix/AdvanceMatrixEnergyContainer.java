...
public class AdvanceMatrixEnergyContainer implements IEnergyContainer {
    private final Map<BlockPos, AdvanceInductionProviderTier> providers = new Object2ObjectOpenHashMap<>();
    ...
    //TODO: Eventually we could look into extending long to have a "BigInt" styled implementation that is used by the class
    ...
    private final AdvanceMatrixMultiblockData multiblock;

    public AdvanceMatrixEnergyContainer(AdvanceMatrixMultiblockData multiblock) {
        this.multiblock = multiblock;
    }

    public void addCell(BlockPos pos, TileEntityAdvanceInductionCell cell) {
        //As we already have the two different variables just pass them instead of accessing world to get tile again
        MachineEnergyContainer<TileEntityAdvanceInductionCell> energyContainer = cell.getEnergyContainer();
    ...
    public void addProvider(BlockPos pos, TileEntityAdvanceInductionProvider provider) {
