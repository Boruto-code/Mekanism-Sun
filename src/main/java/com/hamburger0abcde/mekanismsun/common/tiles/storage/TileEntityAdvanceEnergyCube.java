...
import com.hamburger0abcde.mekanismsun.common.capabilities.AdvanceEnergyCubeEnergyContainer;
...
public class TileEntityAdvanceEnergyCube extends TileEntityConfigurableMachine {
    public static final ModelProperty<CubeSideState[]> SIDE_STATE_PROPERTY = new ModelProperty<>();

    /**
     * This Energy Cube's tier.
     */
    private AdvanceEnergyCubeTier tier;
    private float prevScale;

    @Getter
    private AdvanceEnergyCubeEnergyContainer energyContainer;
    ...
    public TileEntityAdvanceEnergyCube(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
    ...
    protected void presetVariables() {
        ...
        tier = MSAttribute.getAdvancedTier(getBlockHolder(), AdvanceEnergyCubeTier.class);
    }
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener) {
        ...
        builder.addContainer(energyContainer = AdvanceEnergyCubeEnergyContainer.create(tier, listener));
    ...
    public AdvanceEnergyCubeTier getAdvanceTier() {
        return tier;
    }
    ...
    public EnergyCubeUpgradeData getUpgradeData(HolderLookup.Provider provider) {
        return new EnergyCubeUpgradeData(provider, redstone, getControlType(), getEnergyContainer(),
                chargeSlot, dischargeSlot, getComponents());
    }
