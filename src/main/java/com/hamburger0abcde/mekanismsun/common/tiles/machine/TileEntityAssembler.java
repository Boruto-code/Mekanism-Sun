...
public class TileEntityAssembler extends TileEntityProgressMachine<BasicItemItemChemicalRecipe>
    ...
    @Nullable
    @Override
    public BasicItemItemChemicalRecipe getRecipe(int cacheIndex) {
        return findFirstRecipe(itemInputHandler, extraInputHandler, chemicalInputHandler);
    }

    @NotNull
    @Override
    public CachedRecipe<BasicItemItemChemicalRecipe> createNewCachedRecipe(@NotNull BasicItemItemChemicalRecipe recipe, int cacheIndex) {
        return new ItemItemChemicalCachedRecipe(recipe, recheckAllRecipeErrors, itemInputHandler, extraInputHandler,
