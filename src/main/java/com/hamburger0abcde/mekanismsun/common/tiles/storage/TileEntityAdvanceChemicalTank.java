...
import com.hamburger0abcde.mekanismsun.common.capabilities.AdvanceChemicalTankChemicalTank;
...
public class TileEntityAdvanceChemicalTank extends TileEntityConfigurableMachine implements IHasGasMode {
    ...
    @Getter
    private AdvanceChemicalTankTier tier;
    ...
    public TileEntityAdvanceChemicalTank(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
    ...
    public @Nullable IChemicalTankHolder getInitialChemicalTanks(IContentsListener listener) {
        ...
        builder.addTank(chemicalTank = AdvanceChemicalTankChemicalTank.create(tier, listener));
    ...
    public ChemicalTankUpgradeData getUpgradeData(HolderLookup.Provider provider) {
        return new ChemicalTankUpgradeData(provider, redstone, getControlType(), drainSlot, fillSlot, dumping,
                getChemicalTank().getStack(), getComponents());
    }
