...
public class BlockAdvanceFluidTank extends BlockTileModel<TileEntityAdvanceFluidTank,
    ...
    public int getLightEmission(@NotNull BlockState state, @NotNull BlockGetter world, @NotNull BlockPos pos) {
        ...
        TileEntityAdvanceFluidTank tile = WorldUtils.getTileEntity(TileEntityAdvanceFluidTank.class, world, pos);
        if (tile != null) {
    ...
    @Override
    @Deprecated
    public ItemInteractionResult useItemOn(@NotNull ItemStack stack, @NotNull BlockState state, @NotNull Level world,
                                           @NotNull BlockPos pos, @NotNull Player player,
                                           @NotNull InteractionHand hand, @NotNull BlockHitResult hit) {
        if (stack.isEmpty()) {
            return ItemInteractionResult.PASS_TO_DEFAULT_BLOCK_INTERACTION;
        }
        TileEntityAdvanceFluidTank tile = WorldUtils.getTileEntity(TileEntityAdvanceFluidTank.class, world, pos, true);
        if (tile == null) {
