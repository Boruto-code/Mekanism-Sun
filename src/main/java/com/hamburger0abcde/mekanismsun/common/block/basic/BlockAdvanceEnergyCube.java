...
public class BlockAdvanceEnergyCube extends BlockTile.BlockTileModel<TileEntityAdvanceEnergyCube,
        Machine<TileEntityAdvanceEnergyCube>> {
    ...
    public BlockAdvanceEnergyCube(Machine<TileEntityAdvanceEnergyCube> type) {
        super(type, BlockBehaviour.Properties.of()
                .strength(2, 2.4F)
    ...
    public VoxelShape getShape(@NotNull BlockState state, @NotNull BlockGetter world, @NotNull BlockPos pos,
        ...
        TileEntityAdvanceEnergyCube energyCube = WorldUtils.getTileEntity(TileEntityAdvanceEnergyCube.class, world, pos);
        int index;
        if (energyCube == null) {
