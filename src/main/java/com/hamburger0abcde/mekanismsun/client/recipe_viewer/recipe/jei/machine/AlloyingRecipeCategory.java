...
public class AlloyingRecipeCategory extends HolderRecipeCategory<AlloyingRecipe> {
    private final GuiSlot input;
    private final GuiGauge<?> inputGas;
    private final GuiSlot extra;
    private final GuiSlot output;

    public AlloyingRecipeCategory(IGuiHelper helper, RVRecipeTypeWrapper<?, AlloyingRecipe, ?> recipeType) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, RecipeHolder<AlloyingRecipe> recipe, @NotNull IFocusGroup focusGroup) {
