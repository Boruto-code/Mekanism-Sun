...
public class RenderAdvanceFluidTankItem extends MekanismISTER {
    public static final RenderAdvanceFluidTankItem ADVANCE_RENDERER = new RenderAdvanceFluidTankItem();
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext displayContext, @NotNull PoseStack matrix,
        ...
        if (attachment != null) {
            ...
            if (!fluid.isEmpty()) {
                ...
                if (fluidScale > 0) {
                    RenderResizableCuboid.renderCube(RenderAdvanceFluidTank.getFluidModel(fluid, fluidScale), matrix,
                            renderer.getBuffer(Sheets.translucentCullBlockSheet()), MekanismRenderer.getColorARGB(fluid, fluidScale),
