...
public class GuiAdvanceInductionMatrix extends GuiMekanismTile<TileEntityAdvanceInductionCasing,
        MekanismTileContainer<TileEntityAdvanceInductionCasing>> {

    public GuiAdvanceInductionMatrix(MekanismTileContainer<TileEntityAdvanceInductionCasing> container,
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 49, 21, 84, 46, () -> {
            ...
            return List.of(MekanismLang.ENERGY.translate(EnergyDisplay.of(multiblock.getEnergy())),
                    ...
                    MekanismLang.MATRIX_INPUT_AMOUNT.translate(MekanismLang.GENERIC_PER_TICK
                            .translate(EnergyDisplay.of(multiblock.getLastInput()))),
                    MekanismLang.MATRIX_OUTPUT_AMOUNT.translate(MekanismLang.GENERIC_PER_TICK
                            .translate(EnergyDisplay.of(multiblock.getLastOutput()))));
        }).spacing(2));
        addRenderableWidget(new GuiAdvanceMatrixTab(this, tile, GuiAdvanceMatrixTab.AdvanceMatrixTab.STAT));
