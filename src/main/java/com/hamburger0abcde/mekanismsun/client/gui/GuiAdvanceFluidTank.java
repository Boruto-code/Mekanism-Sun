...
public class GuiAdvanceFluidTank extends GuiMekanismTile<TileEntityAdvanceFluidTank,
        MekanismTileContainer<TileEntityAdvanceFluidTank>> {

    public GuiAdvanceFluidTank(MekanismTileContainer<TileEntityAdvanceFluidTank> container,
