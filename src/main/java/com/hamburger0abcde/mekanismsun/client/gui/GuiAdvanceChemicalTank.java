...
public class GuiAdvanceChemicalTank extends GuiConfigurableTile<TileEntityAdvanceChemicalTank,
        MekanismTileContainer<TileEntityAdvanceChemicalTank>> {

    public GuiAdvanceChemicalTank(MekanismTileContainer<TileEntityAdvanceChemicalTank> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalBar(this, GuiChemicalBar.getProvider(tile.getChemicalTank(), tile.getChemicalTanks(null)),
                42, 16, 116, 10, true));
