...
public class GuiAssembler extends GuiConfigurableTile<TileEntityAssembler, MekanismTileContainer<TileEntityAssembler>> {
    public GuiAssembler(MekanismTileContainer<TileEntityAssembler> container, Inventory inv, Component tile) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.inputChemicalTank,
                () -> tile.getChemicalTanks(null), GaugeType.STANDARD, this, 28, 10)
