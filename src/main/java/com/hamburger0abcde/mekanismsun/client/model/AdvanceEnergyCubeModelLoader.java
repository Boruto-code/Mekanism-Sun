...
public class AdvanceEnergyCubeModelLoader implements IGeometryLoader<AdvanceEnergyCubeGeometry> {
    public static final AdvanceEnergyCubeModelLoader INSTANCE = new AdvanceEnergyCubeModelLoader();

    @Override
    public @NotNull AdvanceEnergyCubeGeometry read(@NotNull JsonObject jsonObject, @NotNull JsonDeserializationContext ctx)
        ...
        return new AdvanceEnergyCubeGeometry(frame, leds, ports);
    }
